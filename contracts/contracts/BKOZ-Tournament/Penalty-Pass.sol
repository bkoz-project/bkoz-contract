...
contract PenaltyPass is PermissionsEnumerable, Multicall, ContractMetadata{
    ...
    event PenaltyPassPurchased(address indexed user, address indexed tokenAddress, uint256 price);
    event PenaltyPassRevoked(address indexed user);
    ...
    function buyPenaltyPass(address _tokenAddress) public {
        ...
        emit PenaltyPassPurchased(msg.sender, _tokenAddress, price);
    }
